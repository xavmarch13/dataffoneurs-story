...
After taking the red pill, Neo awakens to a world unlike any he has known—a swirling domain of shapes and colors, each buzzing with energy. These shapes, as he soon realizes, represent the emotions embedded in cinematic narratives. As they float around him, some spike erratically, while others form smooth arcs or jagged peaks. Neo, ever the seeker of truth, begins his journey of clustering these emotions to understand their nature and identify which might pose a threat.

Armed with the elbow method, Neo ensures his classifications are meaningful and precise, dividing the emotions into distinct clusters. His task: to decode the patterns and determine the significance of these emotional arcs.

## Sadness: A Spectrum of Stories

<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_evolution_sadness2.html" width="100%" height="520" frameborder="0"></iframe>

<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_sizes_sadness2.html" width="100%" height="520" frameborder="0"></iframe>
...
<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_evolution_surprise2.html" width="100%" height="520" frameborder="0"></iframe>

<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_sizes_surprise2.html" width="100%" height="520" frameborder="0"></iframe>
...
<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_evolution_fear2.html" width="100%" height="520" frameborder="0"></iframe>

<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_sizes_fear2.html" width="100%" height="520" frameborder="0"></iframe>
...
<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_evolution_joy2.html" width="100%" height="520" frameborder="0"></iframe>

<iframe src="{{ site.baseurl }}/assets/plot/redpill/cluster_sizes_joy2.html" width="100%" height="520" frameborder="0"></iframe>
